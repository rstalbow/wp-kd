						...
						$args = array(
					        ...
					        'tax_query' => array(
					            array(
					                ...
					                'field' => 'id',
					                'terms' => $term->term_id // FYI, it's more stable imho to use the ID if you can. If you do, that switch 'slug' in the preceding line to 'id'
					            )
					        )
					    );
					    $posts_array = get_posts($args);
					    $attachment_thumb = wp_get_attachment_thumb_url($posts_array[0]->ID);
						?>
						<li id="id_<?php echo $term->term_id; ?>" class="lineitem">
							<?php echo $term->name; ?>
							<img src="<?php print $attachment_thumb; ?>">
						</li>
						<?php endforeach; ?>
					</ul>
				</div>
